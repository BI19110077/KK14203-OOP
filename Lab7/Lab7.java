...
class FormPanel extends JPanel implements ActionListener, ItemListener{
   ...
   public FormPanel(){   
      ...
      String[] courses={"[Select]", "KK14203 OOP", "KT14203 CAO", "KT14403 Discrete Structure","UJ00202 BAHASA JEPUN II", "UW00102 HUBUNGAN ETNIK"};
      ...
      b_submit.addActionListener(new ActionListener(){           
         public void actionPerformed(ActionEvent e){  
            ...
            if(matric.getText()!=null){
            
            }
            else{
               JOptionPane.showMessageDialog(null, "Matric number cannot be blank!");
            }
            ...
            if(code.getSelectedItem()!= null){
               ...
               JOptionPane.showMessageDialog(null, "Course is not selected!");
            }     
            ...
            if (rb1.isSelected()||rb2.isSelected()||rb3.isSelected()||rb4.isSelected()||rb5.isSelected()){
               ...
               JOptionPane.showMessageDialog(null, "Rating is not selected!");
            }
            
            //input validation for outcome
            if (c1.isSelected()||c2.isSelected()) {
            } 
            else {
               JOptionPane.showMessageDialog(null, "Outcome is not selected!");
            }
